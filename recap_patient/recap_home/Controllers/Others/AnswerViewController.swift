...
class AnswerViewController: UIViewController {
    ...
    private func configureConstraints() {
        let imageConstraint = questionImageView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 20)
        imageConstraint.isActive = !questionImageView.isHidden
        ...
        NSLayoutConstraint.activate([
            ...
            questionLabel.topAnchor.constraint(
                equalTo: questionImageView.isHidden ? contentView.topAnchor : questionImageView.bottomAnchor,
                constant: 20
            ),
