...
class AddQuestionViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        if let selectedImage = info[.originalImage] as? UIImage {
            ...
            imageView.isHidden = false // Show the imageView after image is added
            image = selectedImage // Save the image
            updateLayoutForImage() // Adjust layout when image is added
        }
    }
